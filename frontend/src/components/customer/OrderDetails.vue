      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="text-center">
            ...
            <p class="text-sm text-gray-600">View your order information</p>
          </div>
          <div class="w-20"></div>
      ...
      <div v-else-if="order" class="space-y-8">
        ...
        >
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <h2
                  class="text-2xl font-bold text-orange-700 flex items-center gap-3"
                >
        ...
        >
          ...
          >
            ...
            <p class="text-blue-600 text-sm mt-1">Medications in your order</p>
          </div>
          ...
          <div class="p-6">
            <div class="space-y-4">
              <div
                ...
                :key="item.id"
                class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-gray-200 transition-colors"
              >
                <div
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-4 mt-3">
                    ...
                    <span class="text-sm text-gray-500"
                      >Unit Price:
                      {{
                        formatCurrency(parseFloat(item.amount) / item.quantity)
                      }}</span
                    >
        ...
        >
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div
                v-if="authStore.user?.role === 'salesperson' && order.customer"
              >
                <h4 class="font-semibold text-gray-800 mb-3">
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-gray-700">{{
                      order.customer.profile?.phone || "No phone"
                    }}</span>
                  </div>
                </div>
              </div>
        ...
        >
          <div
            class="bg-gradient-to-r from-orange-50 to-red-50 px-6 py-4 border-b border-orange-100"
          >
            <h3 class="text-xl font-bold text-orange-700">Order Actions</h3>
            <p class="text-orange-600 text-sm mt-1">Update order status</p>
          </div>
        ...
        >
          ...
          >
            <h3 class="text-xl font-bold text-red-700">Order Management</h3>
            <p class="text-red-600 text-sm mt-1">Manage your order</p>
          </div>
          ...
          <div class="p-6">
            <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
              <div class="flex items-start gap-3">
                ...
                />
                <div>
                  <h4 class="font-medium text-red-800">Cancel Order</h4>
                  <p class="text-sm text-red-700 mt-1">
                    Once cancelled, this action cannot be undone. You will need
        ...
        >
          ...
          <div class="p-6">
            <div class="flex items-center gap-4 text-green-600">
              ...
              <div>
                <p class="font-semibold">Order Delivered Successfully</p>
