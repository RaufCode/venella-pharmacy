...
<template>
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <!-- Empty Cart State -->
            <div v-else-if="!cartStore.carts || cartStore.carts.length === 0" class="text-center py-16">
                <div class="max-w-md mx-auto">
                    <div class="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293A1 1 0 005 16h12M9 19.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM20.5 19.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Your cart is empty</h3>
                    <p class="text-gray-600 mb-8">Add some products to your cart to continue with checkout</p>
                    <button
                        @click="router.push('/')"
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-green-100">
                            ...
                            <p class="text-green-600 text-sm mt-1">Review your items before checkout</p>
                        </div>
                        
                        <div class="p-6">
                            <div class="space-y-4 max-h-96 overflow-y-auto overscroll-contain">
                                <div
                                ...
                                >
                                    <div class="w-16 h-16 bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between mt-3">
                                            ...
                                            <span class="font-bold text-green-600">₵{{ item.product?.price || 0 }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-t border-gray-200 mt-6 pt-6 space-y-3">
                                ...
                                <div class="flex justify-between text-lg font-bold text-gray-800 pt-3 border-t border-gray-200">
                                    <span>Total</span>
                                    <span class="text-green-600">₵{{ totalWithDelivery }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
                        <div class="bg-gradient-to-r from-orange-50 to-red-50 px-6 py-4 border-b border-orange-100">
                            <h2 class="text-xl font-bold text-orange-700 flex items-center gap-2">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-orange-600 text-sm mt-1">Where should we deliver your order?</p>
                        </div>
                            ...
                            <form @submit.prevent="placeOrder" class="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        v-model="form.name"
                                        required
                                        :disabled="isLoading || orderStore.loading"
                                ...
                                <button
                                    type="submit"
                                    :disabled="isLoading || orderStore.loading || !isFormValid"
                                    class="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-4 px-6 rounded-xl font-bold text-lg hover:from-orange-700 hover:to-red-700 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:transform-none disabled:shadow-md"
                                >
                                    <span v-if="isLoading || orderStore.loading" class="flex items-center justify-center gap-2">
