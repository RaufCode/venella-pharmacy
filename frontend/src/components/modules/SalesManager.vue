<template>
  <div class="space-y-6">
    ...
    >
      <div>
        ...
        <p class="text-sm text-gray-600">
          Monitor your pharmacy's sales performance
        </p>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <!-- Sales Chart -->
      <BaseCard title="Sales Trend" subtitle="Daily sales over time">
        <div
    ...
    <BaseCard title="Recent Sales" subtitle="Detailed sales transactions">
      ...
      <div v-else-if="salesData.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-500">Sales transactions will appear here.</p>
      </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <div class="text-sm text-gray-500">
                    {{ getTotalQuantity(sale.order_items) }} units
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="font-semibold"
                  >₵{{ parseFloat(sale.total_amount || 0).toFixed(2) }}</span
                >
              </div>
            </div>
          </div>
  ...
  const topProducts = computed(() => {
    ...
    salesData.value.forEach((order) => {
      order.order_items?.forEach((item) => {
        ...
        productSales[productName].sales_count += parseInt(item.quantity || 0);
