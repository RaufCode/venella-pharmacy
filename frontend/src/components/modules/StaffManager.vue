<template>
  <div class="space-y-6">
    ...
    >
      <div>
        <h2 class="text-xl font-semibold text-gray-900">Staff Management</h2>
    ...
    <BaseCard title="Staff Members" subtitle="Manage your pharmacy staff">
      ...
      <div v-else-if="staffList.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-500">Add your first staff member to get started.</p>
      </div>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-500 mt-1">{{ staff.email }}</p>
                <p class="text-xs text-gray-500">{{ staff.phone }}</p>
                ...
                <div class="flex items-center justify-between mt-4">
                  <span class="text-xs text-gray-500">
                    Added {{ formatDate(staff.date_joined) }}
                  </span>
...
<script setup>
  ...
  const fetchStaff = async () => {
    try {
      ...
      const response = await axios.get("/api/core/accounts/salespersons/");
