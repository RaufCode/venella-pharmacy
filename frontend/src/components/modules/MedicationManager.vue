  ...
  <div class="space-y-6">
    ...
    >
      <div>
        ...
        <p class="text-sm text-gray-600">
          Manage your pharmacy's medication stock
        </p>
      </div>
    ...
    <BaseCard>
      ...
      >
        ...
        <h3 class="text-lg font-medium text-gray-900">No medications found</h3>
      ...
      <div v-else>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  >
                    {{ medication.category?.name || "Uncategorized" }}
                  </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                ...
                <div class="flex items-center justify-between mt-3">
                  <div class="flex items-center gap-4">
                    <span class="text-sm font-medium text-gray-900"
                      >₵{{ parseFloat(medication.price || 0).toFixed(2) }}</span
                    >
                    <span
                      :class="[
                        'text-xs font-medium',
        ...
        >
          <div class="text-sm text-gray-500">
            ...
            {{
              Math.min(currentPage * itemsPerPage, filteredMedications.length)
            }}
