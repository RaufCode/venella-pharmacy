        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-2">
                    Join Venella Pharmacy
                </h1>
                <p class="text-gray-600">Create your account and start your healthcare journey with us</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-8">
                    ...
                    <form @submit.prevent="validation" class="space-y-6">
                        ...
                        <button
                            type="submit"
                            :disabled="authStore.loading || !form.first_name || !form.last_name || !form.email || !form.phone || !form.address || !form.password"
