...
<template>
    <div class="w-full min-h-screen bg-gray-100">
        <!-- Header -->
        <div
            class="hidden md:flex items-center p-4 justify-between shadow sticky top-0 z-50 w-full bg-white"
        >
        ...
        <!-- Main Content -->
        <div
            class="flex flex-col items-center justify-center pt-5 container mx-auto p-4"
        >
            <!-- Search Input -->
            ...
            >
                <div class="flex items-center mb-4 justify-between">
                    <div class="flex items-center space-x-2">
                        ...
                        <h1
                            class="font-medium capitalize text-gray-700 text-sm"
                        >
                            {{ notification.type }}
                        </h1>
                    </div>
                ...
                <div>
                    ...
                    <p class="text-xs mt-2 text-gray-400 flex space-x-2">
                        <span>{{
                    ...
                    <div class="flex justify-end space-x-2 mt-1">
                        <button
                            v-if="!notification.read"
                            class="mt-2 p-1 text-sm text-green-500 hover:underline"
                            @click="
