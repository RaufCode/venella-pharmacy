...
<template>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <!-- Mobile Header -->
        <header
            class="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-b border-gray-200"
        >
            <div class="px-4 py-3 flex items-center justify-between">
                ...
                <h1 class="text-lg font-semibold text-orange-600 truncate">
                    {{ title }}
                </h1>
        ...
        <div class="flex h-screen pt-16 lg:pt-0">
            ...
            <aside
                :class="[
                    'fixed lg:static inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200 transform transition-transform duration-300 lg:translate-x-0',
            ...
            >
                <div class="flex flex-col h-full">
                    ...
                    <div
                        class="hidden lg:block px-4 py-6 border-t border-gray-200"
                    >
            ...
            <main class="flex-1 flex flex-col min-w-0">
                <!-- Desktop Header -->
                <header
                    class="hidden lg:flex items-center justify-between px-8 py-4 bg-white border-b border-gray-200"
                >
                    <div>
